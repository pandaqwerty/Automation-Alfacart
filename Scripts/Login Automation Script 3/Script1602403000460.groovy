...
info.username=data.getValue(1, 3)
info.keterangan=data.getValue(2, 3)
...
WebUI.click(findTestObject('Object Repository/Alfacart/Page_Alfacart_Login_Email/a_MASUK DENGAN GOOGLE'))

WebUI.setText(findTestObject('Object Repository/Alfacart/Page_Alfacart_Login_Email/input_alfacart.com_identifier'),
	Username)
WebUI.sendKeys(findTestObject('Object Repository/Alfacart/Page_Alfacart_Login_Email/input_alfacart.com_identifier'), Keys.chord(Keys.ENTER))
WebUI.setText(findTestObject('Object Repository/Alfacart/Page_Alfacart_Login_Email/input_Terlalu sering gagal_password'),
	'******')
WebUI.sendKeys(findTestObject('Object Repository/Alfacart/Page_Alfacart_Login_Email/input_Terlalu sering gagal_password'), Keys.chord(Keys.ENTER))
...
if (URLLoginSuccess == 'https://www.alfacart.com/customer/account#')
{
	...
	sheet.getRow(8).createCell(9).setCellValue("Test Success");
...
} else 
{
	...
	sheet.getRow(8).createCell(9).setCellValue("Test Failed");
