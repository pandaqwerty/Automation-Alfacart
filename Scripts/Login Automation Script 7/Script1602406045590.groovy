...
WebUI.setText(findTestObject('Object Repository/Alfacart/Page_Alfacart_Login/input_Email  Nomor Ponsel_email'),
	Username)
...
if (URLLoginSuccess != 'https://www.alfacart.com/customer/account')
{
	...
	sheet.getRow(12).createCell(9).setCellValue("Test Success");
...
} else 
{
	...
	sheet.getRow(12).createCell(9).setCellValue("Test Failed");
